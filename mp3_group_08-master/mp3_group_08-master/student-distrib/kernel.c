...
void entry(unsigned long magic, unsigned long addr) {
    ...
    /* Initialize boot block to NULL */
    boot_block_start = NULL;
    ...
    if (CHECK_FLAG(mbi->flags, 3)) {
        ...
        boot_block_start = (boot_block_t*) mod->mod_start;
    ...
    //initialize idt table here
    //printf("wow I can see this message!!!\n");
    //lidt(idt_desc_ptr);
    int_idt();


    /* Init the PIC */
    i8259_init();      //UNCOMMENT THIS WHEN I INITIALIZE PIC
    ...
    file_sys_init(boot_block_start);
